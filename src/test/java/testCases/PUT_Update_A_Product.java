...
public class PUT_Update_A_Product {
	...
	@Test
	public void updateAProduct() throws InterruptedException {
		
		String payloadPath = ".\\src\\main\\java\\Data\\updatePayload.json"; // gets data from payload data file
				
//		HashMap<String,String> payload = new HashMap<String, String>();
//		payload.put("id", "1930");
//		payload.put("name", "Tony's Stories");
//		payload.put("price", "507");
//		payload.put( "description", "Stories of Tony's journey part 2");
...
//		payload.put( "category_name", "Books");
		...
		Response response = 
				...
				.when()
					.put("update.php") // changed to post from get to create
				.then()
